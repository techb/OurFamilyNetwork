...
<?php }elseif( !is_user_logged_in() && in_array('demo', $tag_list) ){ ?>
...
<?php }else{ ?>
	...
	<div id="tribe-events-event-" class="demo-event tribe_events type-tribe_events status-publish has-post-thumbnail hentry tribe-events-venue-68 tribe-events-organizer-18">
		<h3 class="tribe-events-month-event-title"><a href="/event/demo-1/" class="url">Demo Event</a></h3>
	</div><!-- #tribe-events-event-# -->
